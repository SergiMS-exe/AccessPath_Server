...
router.put("/review/:reviewId", sitiosController_1.editReviewController, locationConvert_1.convertToClientMiddleware);
router.delete("/review/:reviewId", sitiosController_1.deleteReviewController, locationConvert_1.convertToClientMiddleware);
