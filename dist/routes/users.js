...
router.get("/savedSites/:userId", usersController_1.getSavedSitesController, locationConvert_1.convertToClientMiddleware);
router.get("/comments/:userId", usersController_1.getUserCommentsController, locationConvert_1.convertToClientMiddleware);
